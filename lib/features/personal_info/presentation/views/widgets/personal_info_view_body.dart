...
// }
//
// class BirthdayScreen extends StatelessWidget {  final Function(DateTime) onContinue; // هذه هي المشكلة
//
// const BirthdayScreen({super.key, required this.onContinue}); // هذا هو الحل!
//
//   @override
//   Widget build(BuildContext context) {
//     return ScreenContent(
